...
1. Create a directory called group:

```sh
	$ mkdir -p /root/.dsh/group
```
2. Create a file named "hosts" and use the editor of your choice to input the IP's for the hosts:
...
```sh
$ git clone[https://github.com/openstack/openstack-ansible.git](https://github.com/openstack/openstack-ansible.git)
```
